...
public class HuespedService implements IHuespedService {
    ...
    public AltaHuespedResultDTO crear(AltaHuespedRequestDTO request) {
        ...
        try {
            ...
            // Chequeo de duplicados (Null-Safe)
            ...
            // Nota: Si el tipoDocumento no existe, el Mapper podría haberlo dejado null o el DAO estático falló.
    ...
    public ModificarHuespedResultDTO modificar(ModificarHuespedRequestDTO request) {
        ...
        try {
            ...
            // Gestionar Dirección ID si viene nulo pero ya existe
            if (dto.direccion != null) {
                ...
                // Si la dirección se modifica independiente, usar su DAO,
                // pero Hibernate Cascade debería manejarlo si modificamos el Huesped.
            }
            ...
            boolean duplicado = dao.leerHuespedes().stream()
                    ...
                    .anyMatch(h ->
                            h.getIdHuesped() != null &&
                                    !h.getIdHuesped().equalsIgnoreCase(dto.idHuesped) && // Que no sea él mismo
                                    h.getTipoDocumento() != null &&
                                    dto.tipoDocumento != null &&
                                    dto.tipoDocumento.tipoDocumento != null &&
            ...
            if (duplicado && (request.aceptarIgualmente == null || !request.aceptarIgualmente)) {
                res.resultado.id = 3;
                res.resultado.mensaje = "El tipo y numero de documento ya existen en otro huésped.";
                return res;
            }

            Huesped modificado = dao.modificar(dto);
            res.resultado.id = 0;
            res.resultado.mensaje = "Modificación exitosa";
            return res;
